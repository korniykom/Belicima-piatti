...
const dishes = [
  {
    ...
    steps: [
      "Приготуйте бульйон з курки",
      "Додайте овочі і спеції",
      "Додайте макаронні вироби і зернові культури",
  ...
  },
  {
    ...
    price: 5.99,
    calories: 300,
    ingredients: ["Буряк", "Картопля", "Морква", "Капуста", "Цибуля"],
    steps: [
      "Наріжте овочі",
      "Приготуйте бульйон",
  ...
  },
  {
    ...
    price: 8.99,
    calories: 350,
    ingredients: ["Салат", "Куряче філе", "Сухарики", "Пармезан", "Соус Цезар"],
    steps: [
      "Розріжте салат",
      "Додайте куряче філе",
      "Посипте сухариками та пармезаном",
      "Полийте соусом Цезар",
